// =======================================================
// vertexBoneWeightDivision.h
// 
// 連続ボーンWeightバッファ、
// 頂点ごとの関連（Meshの）ボーンIDとWeight
// =======================================================
#pragma once
#include <vector>
#include <set>
...
namespace MG {
	class VertexBoneWeightDivision {
	private:
	...
	public:
		...
		static void Uninit();
		static VertexBoneWeightDivision Create(unsigned int count, const VERTEX_BONE_WEIGHT* data = nullptr);
		static void Pad();
	...
	public:
		BUFFER_HANDLE_OPERATOR(VertexBoneWeightDivision)
